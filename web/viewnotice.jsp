...
<div class="div4">
    <div>
        <p style="position: relative;left: 45%;font-size: 35px;color: #FFB800;width: 40%"><i class="layui-icon layui-icon-notice" style="font-size: 35px; color: #FFB800;"></i>&ensp;通知</p>
    </div>
