...
<div class="div4">
    <div style="position: relative;top: 1%">
        <p style="position: relative;left: 36%;font-size: 35px;color: #01AAED;width: 40%"><i class="layui-icon layui-icon-dialogue" style="font-size: 35px; color: #01AAED;"></i>&ensp;有什么想跟管理员说的吗</p>
    </div>
    <form class="layui-form layui-form-pane" action="write" style="position: relative;top: 3%">
